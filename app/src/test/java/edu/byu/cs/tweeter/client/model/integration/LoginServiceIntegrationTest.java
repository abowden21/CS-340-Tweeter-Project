...
public class LoginServiceIntegrationTest {
    ...
    void setup() {
        ...
        loginRequestInvalid = new LoginRequest("@testUser", "NOT_THE_PASSWORD");
        ...
        registerRequestInvalid = new RegisterRequest("@testUser", "", "", "", turtleBytes);
    }
    ...
    @Test
    void test_loginFailure() throws IOException, TweeterRemoteException {
        assertThrows(TweeterRequestException.class, () -> service.login(loginRequestInvalid));
    }
    ...
    @Test
    void test_registerFailure() {
        assertThrows(TweeterRemoteException.class, () -> service.register(registerRequestInvalid));
    }
    ...
    @Test
    void test_logoutFailure() {
        logoutRequestInvalid = new LogoutRequest(new AuthToken("<token that does NOT exist>", ""));
        assertThrows(TweeterRemoteException.class, () -> service.logout(logoutRequestValid));
