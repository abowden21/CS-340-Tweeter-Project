...
public class LoginServiceProxyTest {
    ...
    public void setup() throws IOException, TweeterRemoteException {
        ...
        Mockito.when(serverFacadeMock.login(loginRequestValid, "/auth/login")).thenReturn(loginResponseValid);
        Mockito.when(serverFacadeMock.login(loginRequestInvalid, "/auth/login")).thenReturn(loginResponseInvalid);
        Mockito.when(serverFacadeMock.register(registerRequestValid, "/auth/register")).thenReturn(registerResponseValid);
        Mockito.when(serverFacadeMock.register(registerRequestInvalid, "/auth/register")).thenReturn(registerResponseInvalid);
        Mockito.when(serverFacadeMock.logout(logoutRequestValid, "/auth/logout")).thenReturn(logoutResponseValid);
        Mockito.when(serverFacadeMock.logout(logoutRequestInvalid, "/auth/logout")).thenReturn(logoutResponseInvalid);
